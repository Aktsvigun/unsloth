...
class SyntheticDataKit:
    """
    A class for generating synthetic data using a pretrained language model. This class manages the lifecycle of a vLLM server instance and provides methods for data generation, cleanup, and configuration.
    """
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """
        Initialize a SyntheticDataKit instance from a pretrained model.
        ...
        Args:
                ...
                float8_kv_cache (`bool`): Whether to use float8 for KV cache.
                conservativeness (`float`): Conservativeness parameter for the model.
    ...
    def cleanup(self) -> None:
        """
        Gracefully shut down the vLLM server and perform memory cleanup.
        """
    ...
    def __del__(self) -> None:
        """
        Destructor that ensures proper cleanup when the instance is deleted.
        """
        self.cleanup()
    ...
    def prepare_qa_generation(
        ...
        """
        Prepare configuration for question-answer generation task.

        Args:
                output_folder (`str`): Directory for output files.
                max_generation_tokens (`int`): Maximum number of tokens to generate.
                temperature (`float`): Sampling temperature for generation.
                top_p (`float`): Top-p sampling parameter.
                overlap (`int`): Number of tokens to overlap between chunks.
                default_num_pairs (`int`): Default number of QA pairs to generate.
                cleanup_threshold (`float`): Threshold for cleaning up generated pairs.
