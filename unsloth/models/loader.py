from typing import T, Type, Optional
...
class FastModel(FastBaseModel):
    ...
    def from_pretrained(
        ...
        use_exact_model_name: bool = False,
        auto_model: Optional[Type[PreTrainedModel]] = None,
        ...
        **kwargs,
        ...
        if "pixtral" in lowered_model_name and transformers_version < Version("4.49.0"):
        ...
        elif "qwen2.5" in lowered_model_name and transformers_version < Version(
            "4.49.0"
        ):
            raise RuntimeError(
                "Unsloth: Qwen 2.5 only works on transformers >= 4.49.0." + LATEST
            )
        elif "gemma-3" in lowered_model_name and transformers_version < Version(
            "4.50.0.dev0"
        ):
            raise RuntimeError(
            ...
            "c4ai-command-a-03-2025" in lowered_model_name
        ...
        # Check if VLM
        is_vlm = any(
            x.endswith("ForConditionalGeneration") for x in model_config.architectures
        )
