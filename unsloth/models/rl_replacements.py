...
def sft_trainer_fix_untrained_tokens(
    call_args: dict[str, Any], extra_args: dict[str, Any]
) -> str:
...
def grpo_trainer__get_per_token_logps(function_name: str, function: str) -> str:
    ...
    def _get_per_token_logps(
        self, model, input_ids, attention_mask, logits_to_keep, calc_logprob_flag=None
    ):
        if (
            os.environ.get("UNSLOTH_USE_NEW_MODEL", "0") == "0"
            and not calc_logprob_flag
        ):
