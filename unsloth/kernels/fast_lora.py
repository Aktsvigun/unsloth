...
class LoRA_MLP(torch.autograd.Function):
    ...
    def forward(
        ...
        X: torch.Tensor,
        gateW: torch.Tensor,
        gateW_quant: torch.Tensor,
        gateA: torch.Tensor,
        gateB: torch.Tensor,
        gateS: float,
        upW: torch.Tensor,
        upW_quant: torch.Tensor,
        upA: torch.Tensor,
        upB: torch.Tensor,
        upS: float,
        downW: torch.Tensor,
        downW_quant: torch.Tensor,
        downA: torch.Tensor,
        downB: torch.Tensor,
        downS: float,
        _forward_function: Callable,
...
class LoRA_QKV(torch.autograd.Function):
    ...
    def forward(
        ...
        X: torch.Tensor,
        QW: torch.Tensor,
        QW_quant: torch.Tensor,
        QA: torch.Tensor,
        QB: torch.Tensor,
        QS: float,
        KW: torch.Tensor,
        KW_quant: torch.Tensor,
        KA: torch.Tensor,
        KB: torch.Tensor,
        KS: float,
        VW: torch.Tensor,
        VW_quant: torch.Tensor,
        VA: torch.Tensor,
        VB: torch.Tensor,
        VS: float,
        inplace: bool = True,
    ...
    @torch_amp_custom_bwd
    def backward(
        ctx, dQ: torch.Tensor, dK: torch.Tensor, dV: torch.Tensor
    ) -> tuple[torch.Tensor, ...]:
