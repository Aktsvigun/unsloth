...
class ModelConfig:
	...
	def __post_init__(self):
		"""
		Sets post-initialization parameters based on model configuration.
		"""
...
def get_kernel_test_configs(
	...
	"""
	Generates kernel test configurations.
	"""
	configs_fwd = []
	configs_bwd_dX = []
	configs_bwd_dW = []
...
def remove_feature_flags(
	...
	"""
	Removes specified feature flags from kernel configurations.
	"""
	pruned_configs = []
