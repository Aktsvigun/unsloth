...
def check_valid_config(
	...
	Args:
		...
		use_W1 (bool): Whether to use the first weight matrix (W1) in a fused MoE MLP.
		fuse_mul_post (bool, optional): Whether to fuse the multiplication of topk weights in the epilogue. Defaults to False.
...
def _test_grouped_gemm_forward(
	...
	Args:
		...
		num_warps (int, optional): Number of warps. Defaults to None.
		num_stages (int, optional): Number of stages. Defaults to None.
		autotune (bool, optional): Whether to autotune the kernel. Defaults to False.
		num_autotune_configs (int, optional): Number of autotune configurations. Defaults to None.
...
def _test_grouped_gemm_backward_dX(
	...
	Args:
		...
		use_tma_load_w (bool, optional): Whether to use TMA for loading weights. Defaults to False.
		use_tma_store (bool, optional): Whether to use TMA for storing the output. Defaults to False.
		use_W1 (bool, optional): Whether to use the first weight matrix (W1) in a fused MoE MLP. Defaults to True.
		autotune (bool, optional): Whether to autotune the kernel. Defaults to False.
		num_autotune_configs (int, optional): Number of autotune configurations. Defaults to None.
		BLOCK_SIZE_M (int, optional): Block size for M dimension. Defaults to None.
		BLOCK_SIZE_N (int, optional): Block size for N dimension. Defaults to None.
