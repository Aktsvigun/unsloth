...
class LlamaModelInfo(ModelInfo):
    ...
    Args:
            ...
            instruct_tag (`Optional[str]`):
                    The instruction tag of the model.
            key (`str`):
    ...
    def construct_model_name(
        ...
        """
        Constructs the model name based on the provided parameters.
...
def register_llama_3_1_models(include_original_model: bool = False) -> None:
    ...
    Args:
            include_original_model (`bool`, *optional*, defaults to `False`):
                    Whether to include the original model in the registry.
    """
...
def register_llama_3_2_models(include_original_model: bool = False) -> None:
    """
    Registers Llama 3.2 models in the model registry.
...
def register_llama_models(include_original_model: bool = False) -> None:
    """
    Registers all Llama models (3.1, 3.2, and vision) in the model registry.
