...
class PhiModelInfo(ModelInfo):
    ...
    def construct_model_name(
        ...
        Args:
                ...
                key (`str`): A key used in the construction of the model name.
...
def register_phi_4_models(include_original_model: bool = False) -> None:
    """
    Registers Phi 4 models in the model registry. This function ensures that Phi 4 models are only registered once.
...
def register_phi_4_instruct_models(include_original_model: bool = False) -> None:
    """
    Registers Phi 4 instruct models in the model registry. This function ensures that Phi 4 instruct models are only registered once.
