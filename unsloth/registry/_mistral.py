...
def register_mistral_small_models(include_original_model: bool = False) -> None:
    """
    Registers Mistral Small models in the model registry. This function ensures that the models are registered only once.
...
def register_mistral_models(include_original_model: bool = False) -> None:
    """
    Registers Mistral models by calling the register_mistral_small_models function. This function is used to register all Mistral models, including different versions and instruction tags.
